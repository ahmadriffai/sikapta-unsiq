...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="<?= base_url('assets') ?>/index3.html" class="brand-link">
     <img src="<?= base_url('assets') ?>/img/icon.png" alt="AdminLTE Logo" class="brand-image img-circle" style="opacity: .8">
     <span class="brand-text font-weight-light">Sikapta Unsiq</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">       
        <?php 
          ...
          $queryMenu = "SELECT menu.menu, menu.id
                        FROM menu JOIN menu_role
